        ...
        <div className="relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9098fc] opacity-30  sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]"
            />
          </div>
        </div>
      </div>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0  md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                ...
                <Link href="/pricing" className="text-pink-700 underline-offset-2">
                  {" "}
                  pro plan{" "}
                </Link>
                pro plan.
